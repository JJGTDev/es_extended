Locales['cs'] = {
  ...
  ['command_car_car'] = 'nazev spawnovaneho vozidla nebo hash',
  ['command_cardel'] = 'odstranit vozidlo v blizkosti',
  ['command_cardel_radius'] = 'volitelne, smaze kazde vozidlo ve specifikovanem radiusu',
  ['command_clear'] = 'promaze chat',
  ['command_clearall'] = 'promaze chat pro vsechny hrace',
  ['command_clearinventory'] = 'vymaze inventar hrace',
  ['command_clearloadout'] = 'vymaze vybaveni hrace',
  ['command_setcoords'] = 'teleportuje te na souradnice',
  ['command_setcoords_x'] = 'osa x',
  ['command_setcoords_y'] = 'osa y',
  ['command_setcoords_z'] = 'osa z',
  ['command_setjob'] = 'nastavi praci pro hrace',
  ['command_setjob_job'] = 'nazev hrace',
  ['command_setjob_grade'] = 'pracovni postaveni',
  ['command_setjob_invalid'] = 'prace, pracovni postaveni nebo oboji je neplatne',
  ['command_setgroup'] = 'nastavi skupinu hrace',
  ['command_setgroup_group'] = 'nazev skupiny',
  ['command_giveaccountmoney'] = 'da penize na speicifkovany ucet',
  ['command_giveaccountmoney_account'] = 'platny nazev uctu',
  ['command_giveaccountmoney_amount'] = 'castka',
  ['command_giveaccountmoney_invalid'] = 'neplatny nazev uctu',
  ['command_giveitem'] = 'da item hraci',
  ['command_giveitem_item'] = 'nazev predmetu',
  ['command_giveitem_count'] = 'pocet predmetu',
  ['command_giveweapon'] = 'da zbran hraci',
  ['command_giveweapon_weapon'] = 'nazev zbrane',
  ['command_giveweapon_ammo'] = 'pocet naboju',
  ['command_giveweapon_hasalready'] = 'hrac jiz tuto zbran ma',
  ['command_giveweaponcomponent'] = 'dat kompentu ke zbrani',
  ['command_giveweaponcomponent_component'] = 'nazev komponentu',
  ['command_giveweaponcomponent_invalid'] = 'neplatna komponenta ke zbrani',
  ['command_giveweaponcomponent_hasalready'] = 'hrac jiz tuto komponentu pro zbran ma',
  ['command_giveweaponcomponent_missingweapon'] = 'hrac tuhle zbran nema',
  ['commanderror_argumentmismatch'] = 'pocet v argumentu nesedi (predano %s, ocekavano %s)',
  ['commanderror_argumentmismatch_number'] = 'typ argumentu #%s nesouhlasi (predan text, ocekavano cislo)',
